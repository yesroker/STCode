import { type Paths,SetRequired,LiteralUnion,PartialDeep } from 'file:///node_modules/type-fest/index';
 interface VfsFile {
  isOpen: boolean;
  content: string | any; // 内容可以是任何可序列化的类型
}
...
declare function open<T extends VfsDirectory>(type: 'character' | 'global', path: Paths<T>): Promise<void>;
declare function close<T extends VfsDirectory>(type: 'character' | 'global', path: Paths<T>): Promise<void>;
type Audio = {
  /** 标题 */
  title: string;
  /** 音频的网络链接 */
